	...
	<form action="cupdate.do" method="post" name="form1">
		<table>
			<tbody>
				<tr>
					<th>ID</th>
					<td><input type="text" name="userID" value="${seUser.userID}" readonly="readonly"></td>
				</tr>
				<tr>
					<th>PW</th>
			...
			<tfoot>
				<tr>
					...
					<input type="button" value="회원탈퇴" class="button" onclick="memDel()">
					<input type="button" value="메인으로" onclick="location.href='list.do'"></td>
				</tr>
			</tfoot>
		</table>
	</form>
